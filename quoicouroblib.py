...
def cercle(t,lat_boue,long_boue,k1=20,k2 = 20, r=30, T=200,debug=True):
    lat,long = gps_dd()
    ...
    speed = k1 * np.linalg.norm(v_tilde) + regulation_vitesse(np.linalg.norm(p_tilde-p), vmax=120, vmin=35, coef=0.1, middle=8)
